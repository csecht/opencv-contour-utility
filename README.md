...
Slightly more responsive versions for updating histograms with trackbars is `equalize_linux.py` for Linux systems and `equalize_qt.py` for macOS and Windows systems.
